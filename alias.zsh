...
alias rfig='cd ~/.config/ranger && nvim'
alias efig="cd ~/.config/doom && nvim"
alias qfig="cd ~/.config/qtile && nvim"
alias vfig="cd ~/.config/nvim && nvim"
alias dfig="cd ~/.config/arco-dwm && nvim"
alias xfig="cd ~/.config/xmobar/xmobar && nvim"
alias afig="cd ~/.config/alacritty && nvim"
alias ifig="cd ~/.config/i3 && nvim"
alias zfig="cd ~/.config/zsh && nvim"
alias kfig="cd ~/.config/kitty && nvim"
alias cfig="cd ~/Dotfiles/Pheon-Dev-Dotfiles && nvim"
alias mfig="cd ~/.moc/ && nvim"
alias tfig="cd ~/.tmux && nvim"
alias pfig="nvim ~/.p10k.zsh"
alias xfig="nvim ~/.tmux.conf"
