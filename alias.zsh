...
alias afg="cd ~/.config/alacritty && $EDITOR"
alias dfg="cd ~/.config/arco-dwm && $EDITOR"
alias kfg="cd ~/.config/kitty && $EDITOR"
alias lfg="cd ~/.config/lazygit && $EDITOR"
alias mfg="cd ~/.config/dmenu && $EDITOR"
alias rfg="cd ~/.config/ranger && $EDITOR"
alias tfg="cd ~/.tmux && $EDITOR"
alias sfg="cd ~/.config/arco-st && $EDITOR"
alias nfg="cd ~/.config/nvim && $EDITOR"
alias zfg="cd ~/.config/zsh && $EDITOR"
...
alias pscon="pscale connect $1 $2 --port $3"  # 1: db, 2: branch, 3: port
